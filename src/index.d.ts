declare namespace Cypress {
  interface Chainable {
    ...
    */
    ...
    /**
     * Deletes email based on index top down
     * Gets an email by subject - will only get the first match
     * @param subject a string that can be the whole subject or just partial 
     * @returns {Object}
     */
    getEmailBySubject(subject: String): Chainable<Object>
  }
}
